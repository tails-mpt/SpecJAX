...
| Qwen/Qwen2.5-7B-Instruct | thoughtworks/Qwen2.5-7B-Instruct-Eagle3 | 61.8% | Needs qwen2 patch |
| Qwen/Qwen2.5-14B-Instruct | thoughtworks/Qwen2.5-14B-Instruct-Eagle3 | 60.2% | Needs qwen2 patch |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-7B | thoughtworks/DeepSeek-R1-Distill-Qwen-7B-Eagle3 | 61.5% | Needs qwen2 patch |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-14B | thoughtworks/DeepSeek-R1-Distill-Qwen-14B-Eagle3 | 65.8% | Needs qwen2 patch |
...
sglang-jax natively supports EAGLE3 for LLaMA and Qwen3 targets. For Qwen2/2.5 targets (including DeepSeek-R1-Distill-Qwen), a small patch is needed to add `set_eagle3_layers_to_capture()` to `qwen2.py`. The patch follows the exact pattern in `qwen3.py`. See the [integration plan](../docs/sglang-jax-inference-integration-plan.md) for details.
