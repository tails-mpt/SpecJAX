#!/usr/bin/env bash
# Launch Qwen3-8B Eagle3 training across all 4 workers of this v4-32.
# Usage: bash scripts/run/launch_all_workers_qwen3_8b.sh [--dry-run] [--resume=<ckpt_path>]
set -euo pipefail

SCRIPT="/path/to/specjax/scripts/run/worker_start_qwen3_8b.sh"
...
echo "=== Qwen3-8B Eagle3 — launching ${#WORKERS[@]} workers ==="
