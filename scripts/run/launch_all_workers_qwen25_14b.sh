#!/usr/bin/env bash
# Launch Qwen2.5-14B Eagle3 training across all 4 workers of this v4-32.
# Usage: bash scripts/run/launch_all_workers_qwen25_14b.sh [--dry-run] [--resume=<ckpt_path>]
set -euo pipefail

SCRIPT="/path/to/specjax/scripts/run/worker_start_qwen25_14b.sh"
...
echo "=== Qwen2.5-14B Eagle3 — launching ${#WORKERS[@]} workers ==="
